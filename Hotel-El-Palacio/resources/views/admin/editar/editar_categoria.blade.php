...
<div class="form-wrapper">
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('admin.editar.categoria', $categoria->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="number" name="capacidad" class="form-control" value="{{ old('capacidad', $categoria->capacidad) }}" required>
            </div>

            <div class="form-group">
                <label>Descripción</label>
                <textarea name="descripcion" class="form-control" value="4">{{ old('descripcion', $categoria->descripcion) }}</textarea>
            </div>
